...
RUNTIME_ENV_JSON="{\"API_BASE_URL\":\"${API_BASE_URL:-}\",\"KEYCLOAK_URL\":\"${KEYCLOAK_URL:-}\",\"KEYCLOAK_REALM\":\"${KEYCLOAK_REALM:-}\",\"KEYCLOAK_CLIENT_ID\":\"${KEYCLOAK_CLIENT_ID:-}\",\"KEYCLOAK_SERVER_URL\":\"${KEYCLOAK_SERVER_URL:-}\",\"KEYCLOAK_PROFILE\":\"${KEYCLOAK_PROFILE:-}\",\"PLATFORM_URL\":\"${PLATFORM_URL:-}\",\"DASHBOARD_APP_URL\":\"${DASHBOARD_APP_URL:-}\",\"CREATOR_APP_URL\":\"${CREATOR_APP_URL:-}\",\"WS_STT_URL\":\"${WS_STT_URL:-}\"}"
